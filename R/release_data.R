...
#'
#' @examples
#' squeeze_data(study_id = "coad_silu_2022", molecular_type = "mrnaRnaSeqSampleCount")
#' squeeze_data(study_id = "brca_cptac_2020", molecular_type = "mrnaRnaSeqV2SampleCount")
#' squeeze_data(study_id = "brca_cptac_2020", molecular_type = "massSpectrometrySampleCount")
squeeze_data <- function(study_id, molecular_type) {
